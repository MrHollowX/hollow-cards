    ...
    return `<button class="camera-tile${unavailable ? ' is-unavailable' : ''}" type="button"
      ...
      <span class="camera-feed">
        ${snapshot
          ...
          : `<span class="camera-unavailable"><ha-icon icon="${this._escape(this._config.unavailable_icon)}"></ha-icon><span>Unavailable</span></span>`}
      ...
      <span class="camera-label">
        <ha-icon icon="${this._escape(this._config.camera_icon)}" aria-hidden="true"></ha-icon>
    ...
    this.innerHTML = `<style>${this._css()}</style>
      <ha-card class="nvr-card">
        <header class="nvr-header">
          <span class="nvr-icon"><ha-icon icon="${this._escape(this._config.icon)}" aria-hidden="true"></ha-icon></span>
